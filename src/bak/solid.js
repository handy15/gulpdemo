 ...
 * summary: the javascript for index.html
 */
$(function() {
	$('.project-list .flexslider').each(function(index, element) {
		$(element).flexslider({
			animation: "slide",
...
(function(d) {
	...
	d.flexslider.defaults = {
		namespace: "flex-",	//class前缀
		selector: ".slides > li",//轮播对象的选择器
		animation: "fade",//轮播方式
		easing: "swing",
		direction: "horizontal",//轮播的方向
		reverse: !1,
		animationLoop: !0,//是否循环播放
		smoothHeight: !1,
		startAt: 0,
		slideshow: !0,//是否启动自动播放
		slideshowSpeed: 3000,//播放间隔
		animationSpeed: 400,//切换时间间隔
		initDelay: 0,
		randomize: !1,
		pauseOnAction: !0,
		pauseOnHover: !0,
		...
		touch: !0,
		video: !1,
		controlNav: !0,//是否显示分页导航
		directionNav: !0,//是否显示上一个、下一个
		prevText: "Previous",//上一个 按钮显示的文字
		nextText: "Next",//下一个 按钮显示的文字
		keyboard: !0,
		multipleKeyboard: !1,
		mousewheel: !1,
		pausePlay: !1,
		...
		sync: "",
		asNavFor: "",
		itemWidth: 0,//每个轮播个体的宽度
		itemMargin: 0,//轮播个体间的间距
		minItems: 0,
		maxItems: 0,
		move: 0,//移动的跨度（跨越几个轮播对象）
		start: function() {},//初始化轮播
		before: function() {},//执行轮播前
		after: function() {},//执行轮播结束后
		end: function() {},//执行到最后一屏
		added: function() {},
		removed: function() {}
	};
